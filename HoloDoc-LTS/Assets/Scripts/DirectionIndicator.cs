...
/// From: HoloLens 210 (https://developer.microsoft.com/en-us/windows/mixed-reality/holograms_210)
/// </summary>
public class DirectionIndicator : MonoBehaviour
{
    ...
    public void Update()
    {
        ...
        Vector3 camToObjectDirection = gameObject.transform.position - hololensCamera.transform.position;
    ...
    private bool IsTargetVisible()
    {
        ...
        Vector3 targetViewportPosition = hololensCamera.GetComponent<Camera>().WorldToViewportPoint(gameObject.transform.position);
        ...
        out Quaternion rotation)
    {
        ...
        Vector3 cursorIndicatorDirection = Vector3.ProjectOnPlane(camToObjectDirection, -1 * hololensCamera.transform.forward);
        ...
        {
            cursorIndicatorDirection = hololensCamera.transform.right;
        }
        ...
        rotation = Quaternion.LookRotation(
            hololensCamera.transform.forward,
